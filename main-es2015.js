...
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
     ...
     * @desc nav
     */ 
    const MSG_EXTERNAL_posts$$SRC_APP_HEADER_HEADER_COMPONENT_TS_7 = goog.getMsg("{$startTagSpan}Posts{$closeTagSpan}", { "startTagSpan": "\uFFFD#20\uFFFD", "closeTagSpan": "\uFFFD/#20\uFFFD" });
    I18N_6 = MSG_EXTERNAL_posts$$SRC_APP_HEADER_HEADER_COMPONENT_TS_7;
}
else {
    I18N_6 = $localize `:nav@@posts␟8deccbccff75155dadb7202c32c4d2d381b6356b␟690204825043900036:${"\uFFFD#20\uFFFD"}:START_TAG_SPAN:Posts${"\uFFFD/#20\uFFFD"}:CLOSE_TAG_SPAN:`;
}
var I18N_8;
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
    /**
...
HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], viewQuery: function HeaderComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HeaderComponent_Template_fa_icon_click_40_listener() { return ctx.share(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
     ...
     * @desc posts
     */ 
    const MSG_EXTERNAL_synopsis$$SRC_APP_POSTS_POSTS_COMPONENT_TS_13 = goog.getMsg("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vulputate sagittis velit, eget scelerisque arcu semper finibus.");
    I18N_12 = MSG_EXTERNAL_synopsis$$SRC_APP_POSTS_POSTS_COMPONENT_TS_13;
}
else {
    I18N_12 = $localize `:posts@@synopsis␟5c868157282cdf081f60feec20aafd79b2f1bdb9␟1286313602751382659:Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vulputate sagittis velit, eget scelerisque arcu semper finibus.`;
}
...
ResumeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ResumeComponent, selectors: [["app-resume"]], hostBindings: function ResumeComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("inViewport", function ResumeComponent_Template_app_posts_inViewport_4_listener($event) { return ctx.onViewport($event.value, "posts"); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
const _c4 = function () { return ["My name is Guilherme.", "Be welcome to my Live Resume.", "Down below, you will know me better... :)"]; };
